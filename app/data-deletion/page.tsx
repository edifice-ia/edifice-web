...
export const metadata: Metadata = {
  title: "Suppression des donnees utilisateur - LՃdifice",
  description:
    "Informations pour demander la suppression des donnees utilisateur liees a LՃdifice.",
};
    ...
    <div className="mx-auto max-w-5xl px-5 py-14 sm:px-8 lg:py-20">
      ...
      <section className="mt-10 rounded-lg border border-[#223149] bg-[#0F1724] p-6 sm:p-8">
        <div className="space-y-6 text-lg leading-8 text-[#9EADBF]">
          <p>
            LՃdifice ne stocke pas de donnees Facebook personnelles en dehors
          ...
          <p>
            ...
            LՃdifice, contactez-nous a l&apos;adresse suivante :
          </p>
