...
export function LogPanel({ logs }: { logs: CockpitLog[] }) {
  return (
      ...
      <div className="space-y-3">
        {logs.map((log) => (
          <div
            ...
            className="grid gap-3 rounded-md border border-[#1D2A44] bg-[#08111A] p-3 text-sm md:grid-cols-[72px_90px_1fr_auto]"
          >
