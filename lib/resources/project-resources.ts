// Etat d'accessibilite d'un lien. INVARIANT : tant qu'aucune sonde ne teste
// reellement les URL, la seule valeur honnete est "non testé". Les 27 ressources
// portaient "accessible" en dur, affiche en badge vert a cote d'un etat projet
// presente comme distinct, ce qui laissait croire a une verification qui n'a
// jamais existe : le champ n'est lu nulle part ailleurs que dans le rendu, et
// n'a jamais varie. Ne remettre "accessible" ou "inaccessible" que le jour ou
// une sonde ecrit la valeur.
...
export const projectResources: ProjectResource[] = [
  ...
  {
    name: "GitHub",
    url: "https://github.com/edifice-ia/edifice-web",
    category: "Deploiement & infrastructure",
